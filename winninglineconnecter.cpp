...
void WinningLineConnecter::initialize(int type) {
    switch(type){
    case 0: setupPixmap(); setHeight(10);  setPositionEven();     break;
    case 1: setupPixmap(); setHeight(40);  setPositionDiagonal(); break;
    case 2: setupPixmap(); setHeight(40);  setPositionDiagonal(); break;
    case 3: setupPixmap(); setHeight(260); setPositionBigW();     break;
    case 4: setupPixmap(); setHeight(260); setPositionBigW();     break;
    case 5: setupPixmap(); setHeight(40);  setPositionDiagonal(); break;
    case 6: setupPixmap(); setHeight(40);  setPositionDiagonal(); break;
...
void WinningLineConnecter::setPositionEven() {
    switch(ID) {
...
void WinningLineConnecter::setPositionDiagonal() {
    switch(ID) {
...
void WinningLineConnecter::setPositionBigW() {
    switch(ID) {
